...
public class Login extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Toast.makeText(Login.this,currUser.getUid(),Toast.LENGTH_SHORT).show();
        Button signUp;
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String email, String password, String ph) {
            mEmail = email;
            mPassword = password;
            this.phone = ph;
        }
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            String auth_id=mEmail+"_"+mPassword;
           /* DatabaseReference rootRef= FirebaseDatabase.getInstance().getReference();
            DatabaseReference logRef= (DatabaseReference) rootRef.child("Users").orderByChild("auth_id").equalTo(auth_id);*/
